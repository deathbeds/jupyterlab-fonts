...
const variantPromises: { [key: string]: () => Promise<string> } = {
  '': async () => {
    return (await import(`!!file-loader!../style/fonts/DejaVuSansMono.woff2`)).default;
  },
  Bold: async () => {
    return (await import(`!!file-loader!../style/fonts/DejaVuSansMono-Bold.woff2`))
      .default;
  },
};
  ...
  variants.forEach((variant) => {
    ...
    fonts.registerFontFace({
      ...
      license: {
        ...
        text: async () => {
          return (await import('!!raw-loader!../vendor/dejavu-fonts-ttf/LICENSE'))
            .default;
        },
        holders: [
